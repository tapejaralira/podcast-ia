...
// Tentar carregar OpenAI
let OpenAI = null;
try {
    OpenAI = require('openai');
} catch (error) {
    console.log('⚠️ OpenAI não instalado - usando modo fallback');
}
...
class ClassificadorContextual {
    ...
    classificarPorRegras(titulo) {
        ...
        const melhorContexto = Object.keys(pontuacoes).reduce((a, b) => pontuacoes[a] > pontuacoes[b] ? a : b);
