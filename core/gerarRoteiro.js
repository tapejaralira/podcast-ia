...
const GerenciadorEventos = require('../core/gerenciadorEventos');
const IntegracaoIA = require('../core/integracaoIA');
const DialogosEspontaneos = require('../core/dialogosEspontaneos');
const SistemaRevisao = require('../core/sistemaRevisao');

class GeradorRoteiro {
    constructor() {
        // Caminhos para dados e templates
    ...
    async inicializarSistemasContextuais() {
        if (!this.classificadorContextual) {
            const ClassificadorContextual = require('../core/classificadorContextual');
            const GeradorComentariosContextuais = require('../core/comentariosContextuais');
            const MixadorAutomatico = require('../core/mixadorAutomatico');
